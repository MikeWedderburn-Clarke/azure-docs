...
> [!NOTE]
> NFS 3.0 protocol support in Azure Blob storage is now GA. Check for updates and more details in the [NFS protocol support documentation](../storage/blobs/network-file-system-protocol-support.md).
